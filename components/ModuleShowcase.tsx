...
export function BasicsDataTypesVisual() {
  ...
  return (
    <div className="w-full rounded-2xl bg-[#060609] border border-white/10 p-5 space-y-4 shadow-xl select-none font-mono">
      {/* Header */}
...
export function FunctionsScopeVisual() {
  ...
  return (
    <div className="w-full rounded-2xl bg-[#060609] border border-white/10 p-5 space-y-3.5 shadow-xl select-none font-mono">
      {/* Header */}
      <div className="flex items-center justify-between text-xs pb-2 border-b border-white/10">
        <div className="flex items-center gap-2">
